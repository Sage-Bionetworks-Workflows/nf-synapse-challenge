...
workflow MODEL_TO_DATA {
    ...
    staged_data = SYNAPSE_STAGE_DATA(params.data_folder_id, "data_folder_${params.data_folder_id}")
    staged_gs = SYNAPSE_STAGE_GOLDSTANDARD(params.goldstandard_id, "goldstandard_${params.goldstandard_id}")
    ...
    RUN_DOCKER(submission_ch, staged_data, params.cpus, params.memory, params.log_max_size, CREATE_FOLDERS.output, UPDATE_SUBMISSION_STATUS_BEFORE_RUN.output)
    ...
    VALIDATE(RUN_DOCKER.output, staged_gs, UPDATE_SUBMISSION_STATUS_AFTER_RUN.output, params.validation_script)
    ...
    SCORE(VALIDATE.output, staged_gs, UPDATE_SUBMISSION_STATUS_AFTER_VALIDATE.output, ANNOTATE_SUBMISSION_AFTER_VALIDATE.output, params.scoring_script)
