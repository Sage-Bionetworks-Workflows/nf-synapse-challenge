...
workflow MODEL_TO_DATA {
    ...
    UPDATE_SUBMISSION_STATUS_AFTER_VALIDATE(submission_id, VALIDATE.output.map { it[2] })
    ...
    UPDATE_SUBMISSION_STATUS_AFTER_SCORE(submission_id, SCORE.output.map { it[2] })
