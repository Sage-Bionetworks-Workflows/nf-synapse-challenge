...
workflow MODEL_TO_DATA {
    ...
    submission_id, predictions_file, docker_log_file = RUN_DOCKER(submission_ch, params.container_timeout, params.poll_interval, SYNAPSE_STAGE_DATA.output, params.cpus, params.memory, params.log_max_size, CREATE_FOLDERS.output, UPDATE_SUBMISSION_STATUS_BEFORE_RUN.output)
    UPDATE_SUBMISSION_STATUS_AFTER_RUN(RUN_DOCKER.output.map { it[0] }, "ACCEPTED")
    UPDATE_FOLDERS(submission_ch, params.project_name, predictions_file, docker_log_file)
